# Supercell.ArxanFuckerPP - A tool to remove and re-protect Arxan protection from Supercell's games
Forked from https://github.com/Mimi8298/Supercell.ArxanUnprotector tweaked by jordi with luv :3

**This fork can print the xor key and allows you to kill strings encryption (this makes the game run faster btw) if you want to (you still need to update-crc once you edited)**
