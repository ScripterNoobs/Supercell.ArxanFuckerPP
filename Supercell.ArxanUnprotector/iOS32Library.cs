...
public class iOS32Library : Library
{
    private readonly MachO _macho;
    
    public iOS32Library(string path) : base(new GenericMemoryRangeTableProvider(), new ArmStringEncryptionService())
    {
    ...
    public override IEnumerable<int> InitFunctions
    {
        get
        {
            ...
            while (!data.IsEmpty)
            {
                addresses.Add((int) BitConverter.ToInt32(data));
                data = data.Slice(4);
            }
